...
import (
	...
	"wodchain/common"
	"wodchain/crypto/signify"
	"wodchain/internal/build"
	"wodchain/params"
)
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "wodchain/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "wodchain/internal/version.gitDate="+env.Date)
	}
