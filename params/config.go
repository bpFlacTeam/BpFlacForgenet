...
var (
	...
	// GoerliChainConfig contains the chain parameters to run a node on the G"orli test network.
	...
	// GoerliTrustedCheckpoint contains the light client trusted checkpoint for the G"orli test network.
